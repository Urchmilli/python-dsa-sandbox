...
class LinkedList:
    ...
    def insert_after_value(self, data_after, data_to_insert):
        ...
        if self.head.data == data_after:
            self.head.next = self.Node(data_to_insert, self.head.next)
            return

        itr = self.head
        while itr:
            if itr.data == data_after:
                itr.next = self.Node(data_to_insert, itr.next)
                break
